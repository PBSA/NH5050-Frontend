...
class App extends Component {
  componentDidMount() {
    ...
    } else if (this.props.path !== this.props.checkoutRoute && !this.props.path.includes('/admin') && !this.props.path.includes('/login') && !this.props.path.includes('/widget') && !this.props.path.includes('/widget')) { // check if user is in checkout flow, and tries to access unauthorized page
